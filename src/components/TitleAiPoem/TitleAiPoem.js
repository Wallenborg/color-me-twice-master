    ...
    <div className="title-textAI">
      ...
      <p>
        {assistantResponse?.length
          ? assistantResponse
          : "In hues that dance, opposites unite. In vivid contrast, they ignite. Complimentary colors, bold and bright, A symphony of visual delight. #ColorVerse #YourAuthorAssistant!"}
      </p>
    </div>
